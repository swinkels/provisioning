...
Target *spacemacs* does two things, it installs Spacemacs and my personal
...
#+END_SRC
We install pip to to be able to install virtualenvwrapper, a set of extensions
to virtualenv that make it easier to manage Python virtualenvs.
